...
// RUN: %target-build-swift  -parse-as-library %t/Lib.swift -emit-module -emit-module-path %t/Lib.swiftmodule -module-name=Lib -package-name Pkg -I%t -Xfrontend -experimental-package-cmo -Xfrontend -experimental-allow-non-resilient-access -O -wmo -enable-library-evolution
...
//CHECK-LIB-LABEL: sil_vtable [serialized] PubKlass {
...
//CHECK-LIB-LABEL: sil_vtable package [serialized] PkgKlass {
...
//CHECK-LIB-LABEL: sil_witness_table [serialized] PubStruct: PubProto module Lib {
...
//CHECK-LIB-LABEL: sil_witness_table package [serialized] package PkgStruct: PkgProto module Lib {
